...
## Environments
- Preview: https://main--site-26--s24onboading.hlx.page/
- Live: https://main--site-26--s24onboading.hlx.live/
- Custom Domain: https://site-26.playground.name (Available during the lab)
...
WKND_URL=https://main--site-26--s24onboading.hlx.live ITERATIONS=1000 npm run generate-traffic
```
